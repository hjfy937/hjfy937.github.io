					...
					$input.addEventListener('input', function(){
						...
						if (this.value.trim().length <= 0) {
							...
							datas.forEach(function(data) {
								...
								if (isMatch) {
								//结果标签
                      str += "<div class='search'><a href='"+ data_url +"' class='search-result-title' target='_blank'><dl><dt><img src='"+ data_category +"'></dt><dd><h4>"+ data_title +" </h4>";
							  ...
							  if(start == 0){
								  ...
								  if(end > content.length){
									  ...
									  keywords.forEach(function(keyword){
										  ...
										  str += "<p class=\"search-result\">" + match_content +"...</p></dd></dl></a></div>"
										  }
										  }
										  })
